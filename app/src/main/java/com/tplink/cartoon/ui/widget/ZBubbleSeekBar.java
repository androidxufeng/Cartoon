 ...
 * Author xufeng
 *
 * Ver 1.0, 18-8-3, xufeng, Create file
 */
...
public class ZBubbleSeekBar extends View {
    ...
    private com.xw.repo.BubbleSeekBar.OnProgressChangedListener mProgressListener; // progress changing listener
    ...
    public ZBubbleSeekBar(Context context, AttributeSet attrs) {
    ...
    public ZBubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSectionTextSize = a.getDimensionPixelSize(com.xw.repo.bubbleseekbar.R.styleable.BubbleSeekBar_bsb_section_text_size, DisplayUtil.sp2px(14));
        ...
        if (pos == 0) {
            ...
            mSectionTextPosition = com.xw.repo.BubbleSeekBar.TextPosition.BOTTOM_SIDES;
        } else if (pos == 2) {
            mSectionTextPosition = com.xw.repo.BubbleSeekBar.TextPosition.BELOW_SECTION_MARK;
        } else {
        ...
        mThumbTextSize = a.getDimensionPixelSize(com.xw.repo.bubbleseekbar.R.styleable.BubbleSeekBar_bsb_thumb_text_size, DisplayUtil.sp2px(14));
        ...
        mBubbleTextSize = a.getDimensionPixelSize(com.xw.repo.bubbleseekbar.R.styleable.BubbleSeekBar_bsb_bubble_text_size, DisplayUtil.sp2px(14));
        ...
        mTextSpace = DisplayUtil.dp2px(2);
    ...
    private void initConfigByPriority() {
        ...
        if (mSecondTrackSize < mTrackSize) {
            mSecondTrackSize = mTrackSize + DisplayUtil.dp2px(2);
        }
        if (mThumbRadius <= mSecondTrackSize) {
            mThumbRadius = mSecondTrackSize + DisplayUtil.dp2px(2);
        }
        ...
        if (isShowSectionText) {
            if (mSectionTextPosition == NONE) {
                mSectionTextPosition = com.xw.repo.BubbleSeekBar.TextPosition.SIDES;
            }
            if (mSectionTextPosition == com.xw.repo.BubbleSeekBar.TextPosition.BELOW_SECTION_MARK) {
        ...
        mThumbTextSize = isFloatType || isSeekBySection || (isShowSectionText && mSectionTextPosition ==
                com.xw.repo.BubbleSeekBar.TextPosition.BELOW_SECTION_MARK) ? mSectionTextSize : mThumbTextSize;
    }
    ...
    private void calculateRadiusOfBubble() {
        ...
        mBubbleRadius = DisplayUtil.dp2px(14); // default 14dp
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (isShowSectionText && mSectionTextPosition >= com.xw.repo.BubbleSeekBar.TextPosition.BOTTOM_SIDES) { // 如果Section值在track之下显示，比较取较大值
        ...
        if (isShowSectionText) {
            ...
            if (mSectionTextPosition == com.xw.repo.BubbleSeekBar.TextPosition.SIDES) {
            ...
            } else if (mSectionTextPosition >= com.xw.repo.BubbleSeekBar.TextPosition.BOTTOM_SIDES) {
                String text = getMinText();
                mPaint.getTextBounds(text, 0, text.length(), mRectText);
    ...
    private void locatePositionOnScreen() {
        ...
        mBubbleCenterRawSolidY -= DisplayUtil.dp2px(24);
        if (DisplayUtil.isMIUI()) {
            mBubbleCenterRawSolidY += DisplayUtil.dp2px(4);
        }
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isShowSectionText) {
            ...
            if (mSectionTextPosition == com.xw.repo.BubbleSeekBar.TextPosition.SIDES) {
                ...
                y_ += mRectText.height();
                xLeft = mLeft;
                if (mSectionTextPosition == com.xw.repo.BubbleSeekBar.TextPosition.BOTTOM_SIDES) {
        ...
        if ((!isShowSectionText && !isShowThumbText) || mSectionTextPosition == com.xw.repo.BubbleSeekBar.TextPosition.SIDES) {
        ...
        boolean isShowTextBelowSectionMark = isShowSectionText && mSectionTextPosition ==
                com.xw.repo.BubbleSeekBar.TextPosition.BELOW_SECTION_MARK;
        ...
        if (isShowTextBelowSectionMark || isShowSectionMark) {
            float r = (mThumbRadiusOnDragging - DisplayUtil.dp2px(2)) / 2f;
        ...
        if (isShowThumbText && !isThumbOnDragging && isTouchToSeekAnimEnd) {
            ...
            if (isFloatType || (isShowProgressInFloat && mSectionTextPosition == com.xw.repo.BubbleSeekBar.TextPosition.BOTTOM_SIDES &&
    ...
    private boolean isThumbTouched(MotionEvent event) {
        ...
        return (event.getX() - x) * (event.getX() - x) + (event.getY() - y) * (event.getY() - y)
                <= (mLeft + DisplayUtil.dp2px(8)) * (mLeft + DisplayUtil.dp2px(8));
    }
    ...
    private void showBubble() {
        ...
        if (mLayoutParams == null) {
            ...
            if (DisplayUtil.isMIUI() || Build.VERSION.SDK_INT >= Build.VERSION_CODES.N_MR1) {
    ...
    public com.xw.repo.BubbleSeekBar.OnProgressChangedListener getOnProgressChangedListener() {
        return mProgressListener;
    }

    public void setOnProgressChangedListener(com.xw.repo.BubbleSeekBar.OnProgressChangedListener onProgressChangedListener) {
     ...
     */
    public static abstract class OnProgressChangedListenerAdapter implements com.xw.repo.BubbleSeekBar.OnProgressChangedListener {
    ...
    private class BubbleView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            mBubblePath.quadTo(
                    x1 - DisplayUtil.dp2px(2), y1 - DisplayUtil.dp2px(2),
                    x1, y1
            );
            ...
            mBubblePath.quadTo(
                    x2 + DisplayUtil.dp2px(2), y1 - DisplayUtil.dp2px(2),
                    x0, y0
            );
            mBubblePath.close();
